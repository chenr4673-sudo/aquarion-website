        ...
        <div className="max-w-2xl w-full text-center">
          ...
          <div className="flex gap-4 justify-center">
            <button
              ...
              className="px-6 py-3 bg-primary text-background hover:bg-primary/90 transition-all"
            >
              查看训练计划
            </button>
            <button
              onClick={() => navigate("/assessment")}
              className="px-6 py-3 border border-border hover:bg-secondary transition-all"
            >
              重新评估
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
              ...
              {plans.map((plan) => (
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    {plan.badge && (
                      <span className="px-3 py-1 bg-primary text-background text-xs font-medium uppercase">
                        {plan.badge}
                      </span>
                    )}
                  </div>
            ...
            <button
              ...
              className="w-full mt-6 px-8 py-4 bg-primary text-background text-lg font-medium uppercase tracking-wide hover:bg-primary/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isProcessing ? (
                <>
